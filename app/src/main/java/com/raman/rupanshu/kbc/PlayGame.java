...
public class PlayGame extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedCategoriesNumber = Util.convertStringArrayToInts(
                getSharedPreferences("myPrefs", MODE_PRIVATE).getString("selectedTopics", "[1, 2, 3, 4]"));
    ...
    public void initiateObjects() {
        ...
        tv1 = (TextView) findViewById(R.id.answer_option_one);
        tv2 = (TextView) findViewById(R.id.answer_option_two);
        tv3 = (TextView) findViewById(R.id.answer_option_three);
        tv4 = (TextView) findViewById(R.id.answer_option_four);
        tv_money = (TextView) findViewById(R.id.tv_money);
        tv_lifeLine = (TextView) findViewById(R.id.textView);

        llimg1 = (ImageView) findViewById(R.id.life_line_50_50);
        llimg2 = (ImageView) findViewById(R.id.life_line_flip_the_question);
        llimg3 = (ImageView) findViewById(R.id.life_line_expert_advice);
        llimg4 = (ImageView) findViewById(R.id.life_line_double_tip);

        img = (ImageView) findViewById(R.id.img_background_question);
        img1 = (ImageView) findViewById(R.id.img_background_option_one);
        img2 = (ImageView) findViewById(R.id.img_background_option_two);
        img3 = (ImageView) findViewById(R.id.img_background_option_three);
        img4 = (ImageView) findViewById(R.id.img_background_option_four);
    }
    ...
    public void setSharedPreferences() {
        ...
        crs1 = (ImageView) findViewById(R.id.cross_img_background_option_one);
        crs2 = (ImageView) findViewById(R.id.cross_img_background_option_two);
        crs3 = (ImageView) findViewById(R.id.cross_img_background_option_three);
        crs4 = (ImageView) findViewById(R.id.cross_img_background_option_four);
    ...
    private void showConfirmDialog(String msg) {
        ...
        tv_msg.setText(msg);
        ImageView imgok = (ImageView) popupView.findViewById(R.id.button_ok);
    ...
    public void isAnswerCorrect(View v)  {
        ...
        ImageView imgno = (ImageView) popupView.findViewById(R.id.img_no);
        ...
        ImageView imgyes = (ImageView) popupView.findViewById(R.id.img_yes);
    ...
    private void showRightAnswerMessage() {
        ...
        tv_msg_inplayGame = (TextView) findViewById(R.id.msg_in_playGame);
