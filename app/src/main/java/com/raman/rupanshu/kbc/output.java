...
public class output extends Activity {
    ...
    protected void onResume() {
        ...
        setSharedPreferences();
        kbc = (ImageView) findViewById(R.id.kbc_small);
        button_play = (ImageView) findViewById(R.id.button_play);
        button_high_scores = (ImageView) findViewById(R.id.button_high_scores);
        button_settings = (ImageView) findViewById(R.id.button_settings);

        img_continue_game = (ImageView) findViewById(R.id.img_continue_game);
        A = AnimationUtils.loadAnimation(this, R.anim.animation_button_play);
        tv_continue_details = (TextView) findViewById(R.id.tv_continue_details);
    ...
    private void showRateAppDialog() {
        ...
        final CheckBox checkbox = (CheckBox) popupView.findViewById(R.id.checkbox_again);
    ...
    private void getPlayerName() {
        ...
        popupWindowPlayerName.setFocusable(true);
        popupWindowPlayerName.update();
        et_playername = (EditText) popupView.findViewById(R.id.et_playername);
        final InputMethodManager imm = (InputMethodManager) this.getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED, InputMethodManager.HIDE_IMPLICIT_ONLY);
        A = AnimationUtils.loadAnimation(this, R.anim.animation_button_play);
        A.setDuration(500);
        tv_alert = (TextView) popupView.findViewById(R.id.name_alert);
        Button ok = (Button) popupView.findViewById(R.id.img_ok);
        ok.startAnimation(A);
        ok.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
